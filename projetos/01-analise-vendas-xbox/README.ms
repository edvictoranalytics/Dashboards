...
• Workbook (Pasta de Trabalho) é o arquivo inteiro do Excel (.xlsx), agindo como um "fichário" ou contêiner
...
- A Assests: Recursos: Imagens, vídeos, gifs, paletes de cores,etc
- B Bases: Dados para gerar o dashboard principal ou outros
- C Cálculos: Meio campo que processa dados para transformar em informações
- D Dashboards: Principal visual.
- E Anotações: Registro de informações.

# O que são esses dados em "Bases"?
